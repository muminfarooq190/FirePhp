    ...
    <nav class="white">
        <div class="nav-wrapper ">
            ...
            <a href="#" class="brand-logo left"
               style="width: 160px; height: 60px; color: #fff; background-color: #2a92bd;">Converted</a>
    ...
    <div class="travellerwrapper">
        <div class="left">
            <ul class="collapsible ">
                <li class="disabled">
                    <div style="text-align: center;color: #3d3c3c;" class="collapsible-header"><i
                                style="background-color: #2a92bd; width: 25px; border-radius: 50%; color: #fff;"
                                class="material-icons floating   ">add</i> TRAVELLER DETAILS
                    </div>
                ...
                <li>
                    <div style=" color: #3d3c3c;;" class="collapsible-header"><i
                                style="background-color: #2a92bd; width: 25px; border-radius: 50%; color: #fff;"
                                class="material-icons floating   ">add</i>LEAD PROGRESS
                ...
                <li>
                    <div style="color: #3d3c3c;" class="collapsible-header"><i
                                style="background-color: #2a92bd; width: 25px; border-radius: 50%; color: #fff;"
                                class="material-icons floating   ">add</i>NOTES
                    </div>
                    <div class="collapsible-body">
        ...
        <div class="right">
            <ul style="width: 1000px" class="collapsible">
                <li style="width: 1000px;">
                    <div style="width: 1000px; color: #3d3c3c;" class="collapsible-header"><i
                                style="background-color: #2a92bd; width: 25px; border-radius: 50%; color: #fff;"
                                class="material-icons floating   ">add</i> TRAVELLER REQUIREMENTS
                    </div>
                    <div style="width: 1000px; " class="collapsible-body">
                        ...
                        <div style="border-top: 1px solid #ccc; border-bottom: 1px solid #ccc; padding-left: 20px;"
                             class="row">
                            <div style="padding: 10px; border-right: 1px solid #ccc;" class="col s4">
                                <div class="columnalign">
                ...
                <li style="width: 1000px;">
                    <div style="width: 1000px; color: #3d3c3c;" class="collapsible-header">
                        <i style="background-color: #2a92bd; width: 25px; border-radius: 50%; color: #fff;" class="material-icons floating   ">add</i>
                        Quotation
                    </div>
                    <div style="width: 1000px;" class="collapsible-body">
                        <div style="border-bottom:2px solid #2a92bd" class="row">
                            ...
                            <div style="border:2px solid #2a92bd; border-bottom:none; height: 70px; background-color: white; margin-bottom: -1.5px;"
                                ...
                                <div style="display:flex;flex-direction: column; padding: 10px;" class="">
                                    ...
                                    <span style="color: #c2c2af;">Updated 20-05-2020
                        ...
                        <div style="border-bottom: 1px solid #ccc; border-left: 0px; border-right: 0px; height: 30px;"
                             class="row">
                            <div class="col ">
                            ...
                            <div class="col s10">
                                <div class="basic1">
                                    ...
                                    <p style="font-size: 12px;">
                                        ...
                                        On arrival at Srinagar Airport, refresh your mind at the hotel with a welcome
                                        drink. Post hot lunch at the hotel, get ready for some adventure. Drive to visit
                                        the famous Mughal gardens in Srinagar which are Nishat Bagh, the garden of
                                        Pleasure is a twelve terraced garden built by Mughals. The garden is
                                        strategically located on the bank of the Dal Lake, with the snowy Zabarwan
                                        Mountains in its backdrop.
                                        Shalimar Bagh, abode of love is the crown of Srinagar city. The largest of the
                                        Mughal gardens, thegarden was gift from Mughal Emperor Jahangir to his wife Noor
                                        Jahan.
                                        Seek blessing from the Lord Shiva at the Shankaracharya Temple on top of the
                                        Shankaracharya Hill on the Zabarwan Mountain in Srinagar, Kashmir.
                                        You will have to climb about 300 m above a magestic view of Srinagar. A birds
                                        eyeview of the Srinagar and Dal lake.
                                        Visit the Chasmishahi garden, located in the Zabarwan Range, near Raj Bhawan
                                        (Governor‘s house) overlooking Dal Lake.
                                        You can visit the Pari Mahal (Fairy Palace) that lies near the garden where Dara
                                        Sikoh used to learn astrology and where he was later killed by his brother
                                        Aurengzeb.
                ...
                <li style="width: 1000px;">
                    <div style="width: 1000px; color: #3d3c3c;" class="collapsible-header">
                        <i style="background-color: #2a92bd; width: 25px; border-radius: 50%; color: #fff;" class="material-icons floating   ">add</i> Vouchers and Payments
                    </div>
                    <div style="width: 1000px;" class="collapsible-body">
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col s4">
                                <div style="display: flex; flex-direction: column;" class="">
                                    <div style="font-size: 14px; font-weight: bolder;" class="">
                                        Traveller Net Payable <i style="vertical-align: middle;"
                                                                 class="tiny material-icons">add</i>
                                    </div>
                ...
                <li style="width: 1000px;">
                    <div style="width: 1000px; color: #3d3c3c;" class="collapsible-header"><i
                                style="background-color: #2a92bd; width: 25px; border-radius: 50%; color: #fff;"
                                class="material-icons floating   ">add</i> Travellers Review
                    </div>
                    <div style="width: 1000px;" class="collapsible-body">
